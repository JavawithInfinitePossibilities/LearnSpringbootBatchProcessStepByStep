...
@SpringBootTest(classes = Division03IntroductionToSpringBatchStepExecutionarListener.class)
@SpringBatchTest
@Import(MyTestConfigClass.class)
class Division03IntroductionToSpringBatchStepExecutionarListenerTest {
