...
import com.sid.tutorials.springboot.batch.processer.reader.StatelessItemReader;
...
public class JobParameterJobConfiguration {
	...
	@Bean
	public Step step1() {
		return stepBuilderFactory.get("stepReader1ListenerStart").<String, String>chunk(2).reader(statelessItemReader())
				.writer((list) -> {
