...
@SpringBootTest(classes = Division03IntroductionToSpringBatchJobExecutionarlistener.class)
@SpringBatchTest
@Import(MyTestConfigClass.class)
class Division03IntroductionToSpringBatchJobExecutionarlistenerTest {
