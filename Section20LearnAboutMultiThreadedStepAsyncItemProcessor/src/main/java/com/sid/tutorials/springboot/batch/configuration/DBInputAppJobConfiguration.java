...
public class DBInputAppJobConfiguration {
	...
	public Step step1() throws Exception {
		...
		return stepBuilderFactory.get("multithreadedStepApplication1Start-" + value)
	...
	public Job listenerJob() throws Exception {
		int value = random.nextInt(10);
		return jobBuilderFactory.get("MultithreadedStepApplicationJobConfiguration-" + value).start(step1()).build();
	}
