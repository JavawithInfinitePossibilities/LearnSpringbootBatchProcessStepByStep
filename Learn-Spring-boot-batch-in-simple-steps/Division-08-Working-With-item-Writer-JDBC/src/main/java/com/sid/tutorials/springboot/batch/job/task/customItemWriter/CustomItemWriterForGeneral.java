...
public class CustomItemWriterForGeneral {
	...
	@Autowired
	@Qualifier("springBatchCoreDataRepositoryCopy")
	private DataSource springBatchCoreDataRepositoryCopy;
	...
	@Bean
	@StepScope
	public JdbcBatchItemWriter<? extends GeneralBean> customerItemWriterIngeneralForJDBC(
			@Value("#{jobParameters['outputFile']}") String resource) {
		JdbcBatchItemWriter<Customer> itemWriter = new JdbcBatchItemWriter<>();
		itemWriter.setDataSource(this.springBatchCoreDataRepositoryCopy);
