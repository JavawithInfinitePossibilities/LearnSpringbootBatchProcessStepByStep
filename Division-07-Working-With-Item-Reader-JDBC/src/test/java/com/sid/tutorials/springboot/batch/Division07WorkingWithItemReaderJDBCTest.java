...
@SpringBootTest(classes = Division07WorkingWithItemReaderJDBC.class)
@SpringBatchTest
@Import(MyTestConfigClass.class)
class Division07WorkingWithItemReaderJDBCTest {
	...
	void testStep() throws Exception {
		JobParameters jobParameters = new JobParametersBuilder().addString("inputFiles", "CustomerDetails").toJobParameters();
