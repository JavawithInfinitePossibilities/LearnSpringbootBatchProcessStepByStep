...
@SpringBootTest(classes = Division06JobHandlingwithRESTAPIAndSpringSchedularScheduler.class)
@SpringBatchTest
@Import(MyTestConfigClass.class)
class Division06JobHandlingwithRESTAPIAndSpringSchedularSchedulerTest {
